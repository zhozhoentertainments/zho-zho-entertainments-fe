            ...
            <div className="flex items-center gap-3">
              {SOCIALS.map(({ href, icon: Icon, label, small }) => (
                <a
                  ...
                  rel="noreferrer"
                  aria-label={label}
                  className="w-11 h-11 flex items-center justify-center border border-[rgba(92,225,230,0.35)] bg-[#0A0515] text-[#5CE1E6] transition-all duration-300 hover:bg-[#5CE1E6] hover:text-black hover:-translate-y-1 skew-x-3 rounded-md shadow-lg"
                >
